...
import com.crumbpicker.client.css.AppBundle;
 ...
 *
 */
public class CrumbPickerEntryPoint implements EntryPoint {
  ...
  private void createTabletDisplay(ClientFactory clientFactory) {
    ...
    ActivityMapper navActivityMapper = new com.crumbpicker.client.TabletNavActivityMapper(clientFactory);

    AnimationMapper navAnimationMapper = new com.crumbpicker.client.TabletNavAnimationMapper();
    ...
    AnimationMapper tabletMainAnimationMapper = new com.crumbpicker.client.TabletMainAnimationMapper();
